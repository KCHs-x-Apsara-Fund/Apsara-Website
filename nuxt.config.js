export default {
	...
	head: {
		...
		meta: [
			...
			{ hid: 'description', name: 'description', content: 'Apsara Fund Management' },
      { hid: 'og:title', name: 'og:title', content: 'Apsara Fund' },
      { hid: 'og:image', name: 'og:image', content: 'https://apsarafund.netlify.app/assets/img/og.png' },
		],
		link: [
	...
	css: [
		'@/assets/css/main.css',
    '@/assets/css/_page-transition.css',
	],
