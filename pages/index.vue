  ...
  <body>
      ...
      <div class="carousel-inner-a">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            ...
            <h1 class="wow fadeInUp animated HT" data-wow-delay="0.2s">
    ...
    <div class="our-case section-spacing">
      <div class="container">
              ...
              <div class="single-case-block">
                ...
                <div class="hover-content">
                  <div class="text clearfix">
                    ...
                    <a href="project-details.html" class="details float-right"
        ...
        <!-- /.wrapper -->
        <div class="view-all">
          <a href="project.html" class="theme-button-one">VIEW ALL</a>
        </div>
      </div>
      <!-- /.container -->
    </div>
                      ...
                      <div id="collapse1" class="panel-collapse collapse">
                        <div class="panel-body">
                          <p>
                            ...
                            tropic port aboard this tiny ship today still wanted
                            by the government they survive as soldiers of
                            fortune to a deluxe you apartment.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-12">
              <div class="single-block">
                ...
                <p>
                  The Love Boat soon will be making another run explore strange
            ...
            <div class="carousel-item active">
              <div class="cards-wrapper">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">
                      Kind of torture to have to watch the show the one day
                    </h5>
